...
Bu bolumde laboratuvarlarin ayrintili uygulama adimlari verilir.
Her lab, dogrudan echOS kaynak dosyasi uzerinde ilerler.

## Lab formati

Her lab su sabit formatta gelir:
...
## Lab 1 - Cekirdek modul haritalama
...
"Bir modulu yanlis kategoriye koyarsan hangi mimari yanlis yorumu uretirsin?"

### Rubrik

- 40 puan: dogru siniflandirma
- 30 puan: baglantilarin dogru kurulmasi
- 30 puan: yorum kalitesi

---

## Lab 2 - Boot yolunda failure analizi
...
"IOMMU tablosu var ama hardware enable fail ise en kotu risk nedir?"

### Rubrik

- 50 puan: hata matrisi
- 25 puan: containment onerisi
- 25 puan: log okuma netligi

---

## Lab 3 - Scheduler secim izi
...
"Yanlis secim sirasi hangi gorev sinifini ac birakir?"

---

## Lab 4 - RT policy tuning
...
"Dilimleri cok buyuk secersen hangi gecikme davranisi bozulur?"

---

## Lab 5 - CFS vruntime deneyi
...
"Agirlik 0 guard'i olmazsa ne olur?"

---

## Lab 6 - EEVDF eligibility tablosu
...
"`slice_ns` cok kucuk secilirse ne olur?"

---

## Lab 7 - Deque race walkthrough
...
"`SeqCst` fence kaldirilirsa hangi bug sinifi dogar?"

---

## Lab 8 - Timing wheel seviye secimi
...
"Cascade unutulursa hangi gorev semptomu olusur?"

---

## Lab 9 - Zone fallback deney tasarimi
...
"Fallback sayisi artarken sistem neden hala 'calisiyor gibi' gorunebilir?"

---

## Lab 10 - Buddy split/coalesce izleme
...
"Yanlis buddy hesabinda hangi iki semptom gorulur?"

---

## Lab 11 - COW fault yurutme izi
...
"Refcount hatali tutulursa ne tur veri bozulmasi olusur?"

---

## Lab 12 - Reclaim ve writeback butce deneyi
...
"Writeback budget sifira yakin tutulursa ne olur?"

---

## Lab 13 - io_uring publication boundary
...
"Tail erken publish edilirse ne tur bug gorulur?"

---

## Lab 14 - Net parser ve state machine guvenligi
...
"Bir parser guard'i kaldirilirsa ilk hangi test kirilmali?"

---

## Degerlendirme ust tablosu

| Lab | Teknik dogruluk | Analiz kalitesi | Hata avi |
|---|---:|---:|---:|
| 1-4 | 40 | 35 | 25 |
| 5-8 | 45 | 30 | 25 |
| 9-12 | 45 | 35 | 20 |
...
Toplam not, teori + uygulama dengesiyle verilir.
