//! gpu_test - echOS GPU Doğrulama Aracı
//!
//! Bu dosya; kullanıcı alanından DRM/Virtgpu ioctl çağrıları aracılığıyla
//! GPU sürücüsünün çevrimiçi olduğunu doğrulayan minimal bir test uygulamasıdır.
//! virtio-gpu sürücüsünün versiyon bilgisini sorgular ve bir GPU kaynağı oluşturarak
//! DRM alt sisteminin düzgün çalıştığını teyit eder.
