...
/// Allocate contiguous physical memory and return physical address
/// Used by drivers like NVMe for DMA buffers
...
/// Free contiguous physical memory allocated by alloc_phys
pub fn free_phys(phys_addr: u64, size: usize) {
    let page_size = 4096;
    let pages = (size + page_size - 1) / page_size;
    
    // Create PhysFrame from address
...
/// Overload for u64 virtual address
