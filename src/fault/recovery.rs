...
use super::severity::{RecoveryResult, Severity};
...
impl RecoveryStrategy {
    pub fn new(
        ...
        fallback: Option<RecoveryAction>,
        last_resort: RecoveryAction,
    ) -> Self {
        Self {
            primary,
            fallback,
    ...
    pub fn for_fault(fault: &Fault) -> Self {
        match &fault.fault_type {
            ...
            FaultType::TaskLeak => {
                Self::new(RecoveryAction::LogOnly, None, RecoveryAction::LogOnly)
            }
            ...
            // Varsayılan
            _ => Self::new(RecoveryAction::LogOnly, None, RecoveryAction::LogOnly),
        }
    }
}
