//! # Launchpad
//!
//! macOS-style app grid launcher with search and folders
//! Full-screen overlay with animated app icons
...
/// A folder containing multiple apps
#[derive(Clone, Debug)]
