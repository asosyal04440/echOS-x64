...
"D:\Intel Simics Package Manager\simics-simics-gui-external-7.0.3\bin\simics-gui.bat" --project "C:\Users\Bahadir\Desktop\dersler_ve_projeler\echOS\Simics\echos-simics" %*
