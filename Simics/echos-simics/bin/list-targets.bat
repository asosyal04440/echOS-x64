...
"D:\Intel Simics Package Manager\simics-7.70.0\bin\list-targets.bat" %SIMICS_EPL% --project "C:\Users\Bahadir\Desktop\dersler_ve_projeler\echOS\Simics\echos-simics" %*
